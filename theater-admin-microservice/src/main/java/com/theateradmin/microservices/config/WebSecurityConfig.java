package com.theateradmin.microservices.config;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
   ...
   /* @Value("${theater.admin.microservice.user}")
    private String userName;
    @Value("${theater.admin.microservice.password}")
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        UserDetails userDetails = User.withUsername("shubham")
                .password(bCryptPasswordEncoder.encode("gupta")).authorities("read").build();
